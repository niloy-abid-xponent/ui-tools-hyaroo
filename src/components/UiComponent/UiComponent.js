...
export default function UiComponent(props) {
  ...
  // console.log("from ui", card);

  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 lg:px-24">
      <h2 className="text-2xl text-gray-900 font-extrabold mb-2">{title}</h2>
      <p className="text-sm text-gray-500 border-b-2 pb-8">{description}</p>
